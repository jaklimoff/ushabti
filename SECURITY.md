...
- **The rate limit is one process deep.** Ten failed sign-ins, sign-ups or
  agent tokens in ten minutes are answered `429`, counted per address and, for
  sign-in, per email. The count is held in memory, so a restart forgets it and
