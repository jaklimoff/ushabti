...
- **A view is made only from the `+` in the view strip.** The "Add view" form at the foot of
  **Settings → Views** is gone; that page renames, regroups, reorders and deletes, and its note
  says where a new view comes from.
